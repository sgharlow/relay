...
**Claude-court rows opened by the beta sprints (§3, revision 8), named here so the court guard sees them:** ~~row **1.3** (A0.2b)~~ ✅ done 09-10 (PR #65) · row **1.5** (D1/D2/D19 chains) · row **1.6** (the Outlook sentence) · row **2.2** (observe B15.1) · row **2.5** (E1′ first-line instrument, build half) · row **3.1** (observe the 90% rung) · row **3.2** (A3.6 report).
