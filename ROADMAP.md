...
| **B15.1** | the reminder ladder's first firing | **2026-09-21**, the live owner's 75% rung. No walk can substitute — the sweep writes its row only on delivery and the mailer refuses reserved TLDs |
