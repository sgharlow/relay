...
| date | what | owner |
|---|---|---|
| ~2026-09-04 | `verify:live` freshness dead-man fires — **14 days from the NEWEST stamp, so derive it, do not read it here**: `tail -1 docs/verify-live-runs.jsonl`. ⚠️ This cell read `~2026-09-03` until 2026-08-21, computed from the 8-20 stamp while a newer 8-21 stamp already existed — a date copied from a file that moves | claude |
