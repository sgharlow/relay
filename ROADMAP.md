...
| **B11.2** | the cadence re-measure | ✅ done 2026-09-02 — still collapsed after the reset (7/24h on both monitors, 09-03T02Z); cause recorded in `deferred.the-scheduled-monitors-are-collapsing.revisit_outcome`; B12.i awaits its install |
